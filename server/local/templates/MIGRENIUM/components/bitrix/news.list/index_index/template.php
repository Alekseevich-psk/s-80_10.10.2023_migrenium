                ...
                <?if ($arSection["VIDEOS"] && $arSection["VIDEOS_M"]):?>
                    <div class="main__video">
                        ...
                        <script type="application/ld+json">
                        {
                            ...
                            "@type": "VideoObject",
                            "name": "Болеутоляющее лекарство Мигрениум таб 65мг 500мг no №20",
                            "description": "Лекарственный препарат Мигрениум помогает избавиться от боли любого характера, обладает жаропонижающим действием. Продается",
                            "uploadDate": "2024-11-14",
                            "duration": "PT20S",
                            "contentUrl": "<?=$GLOBALS['site_url'];?><?=$arSection["VIDEO_SCHEMAORG"];?>",
                            "embedUrl" : "<?=$GLOBALS['site_url'];?><?=$arSection["VIDEO_SCHEMAORG"];?>",
                            "thumbnailUrl" : "<?=$GLOBALS['site_url'];?><?=SITE_TEMPLATE_PATH;?>/images/migrenium_box.png"
                        }
                        </script>
                        ...
                        <script type="application/ld+json">
                        {
                            "@context": "https://schema.org/",
                            "@type": "VideoObject",
                            "name": "Обезболивающее лекарство Мигрениум таб 65мг 500мг no №20",
                            "description": "Безрецептурный лекарственный препарат migrenium помогает избавиться от боли любого характера, обладает жаропонижающим действием",
                            "uploadDate": "2024-11-14",
                            "duration": "PT20S",
                            "contentUrl": "<?=$GLOBALS['site_url'];?><?=$arSection["VIDEO_SCHEMAORG_M"];?>",
                            "embedUrl" : "<?=$GLOBALS['site_url'];?><?=$arSection["VIDEO_SCHEMAORG_M"];?>",
                            "thumbnailUrl" : "<?=$GLOBALS['site_url'];?><?=SITE_TEMPLATE_PATH;?>/images/migrenium_box.png"
                        }
                        </script>
                    </div>
                ...
                <?if ($arSection["SLIDER"]):?>
                    <div class="main__container">
                        <div class="main__wrapper">
                            <h1 class="main__title dev__main__title--absolute">
                                Препарат Мигрениум
                            </h1>
            ...
            <section class="about-product" data-section-id="<?=$arSection["ID"];?>">
                <div class="about-product__container container">
                    <div class="about-product__sub-wrapper">
                        <h2 class="about-product__s-title s-title">
                            <?=$arSection["TEXT"];?>
                        </h2>
                    ...
                    <div class="about-product__wrapper">
                        <div class="about-product__inner about-product__inner--picture">
                            <div class="about-product__picture">
                                <img src="<?=$arSection["IMG"];?>" alt="Таблетки Мигрениум фото упаковки">
                            </div>
                        </div>
        ...
        <?if ($arSection["ID"] == 5):?>
            ...
            <section class="buy" id="buy" data-section-id="<?=$arSection["ID"];?>">
                <div class="buy__container container">
                    ...
                    <?if ($arSection["SHOPS"]):?>
                        <div class="buy__slider swiper-container">
                            <div class="buy__wrapper swiper-wrapper">
                                <?foreach ($arSection["SHOPS"] as $arItem):?>
                                    <a href="<?=$arItem["LINK"];?>" class="buy__slide swiper-slide dev__buy__slide__link" target="_blank">
